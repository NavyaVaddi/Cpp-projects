...
{
    system("Color 3F");
     /*number will contain random number chosen by computer.guess will contain the number guessed by the user.numberofguess will count the number of times user has taken to guess the correct number. */
